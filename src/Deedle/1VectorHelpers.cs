...
namespace Deedle
{
  ...
  internal static class VectorHelpers
  {
    ...
    internal static FSharpFunc<FSharpList<OptionalValue<T>>, OptionalValue<T>> VectorListTransformGetFunction<T>([In] VectorListTransform obj0)
    {
      ...
      return (FSharpFunc<FSharpList<OptionalValue<T>>, OptionalValue<T>>) new VectorHelpers.VectorListTransform\u002DGetFunction<T>(((VectorListTransform.Binary) vectorListTransform).item.GetFunction<T>());
    }
    ...
    [Serializable]
    internal sealed class VectorListTransform\u002DGetFunction<T> : FSharpFunc<FSharpList<OptionalValue<T>>, OptionalValue<T>>
    {
      [DebuggerBrowsable(DebuggerBrowsableState.Never)]
      [CompilerGenerated]
      [DebuggerNonUserCode]
      ...
      [CompilerGenerated]
      [DebuggerNonUserCode]
      internal VectorListTransform\u002DGetFunction(FSharpFunc<OptionalValue<T>, FSharpFunc<OptionalValue<T>, OptionalValue<T>>> reduction)
      {
        this.ctor();
    ...
    internal class RowReaderVector<T> : IVector, IVector<T>
    {
      ...
      OptionalValue<T> IVector<T>.GetValue(long columnAddress)
      {
        ...
        FSharpFunc<object, T> fsharpFunc = (FSharpFunc<object, T>) new VectorHelpers.Deedle\u002DIVector\u002DGetValue<T>(ConversionKind.Flexible);
      ...
      IEnumerable<OptionalValue<object>> IVector.get_ObjectSequence()
      {
        return (IEnumerable<OptionalValue<object>>) SeqModule.Map<OptionalValue<T>, OptionalValue<object>>((FSharpFunc<M0, M1>) new VectorHelpers.Deedle\u002DIVector\u002Dget_ObjectSequence<T>((FSharpFunc<T, object>) new VectorHelpers.Deedle\u002DIVector\u002Dget_ObjectSequence<T>()), (IEnumerable<M0>) this.DataArray);
      }
      ...
      OptionalValue<object> IVector.GetObject(long i)
      {
        FSharpFunc<T, object> fsharpFunc = (FSharpFunc<T, object>) new VectorHelpers.Deedle\u002DIVector\u002DGetObject<T>();
    ...
    [Serializable]
    internal sealed class Deedle\u002DIVector\u002DGetValue<T> : FSharpFunc<object, T>
    {
      [DebuggerBrowsable(DebuggerBrowsableState.Never)]
      [CompilerGenerated]
      [DebuggerNonUserCode]
      ...
      [CompilerGenerated]
      [DebuggerNonUserCode]
      internal Deedle\u002DIVector\u002DGetValue(ConversionKind conversionKind)
      {
        this.ctor();
        this.conversionKind = conversionKind;
      }
