...
namespace Deedle
{
    ...
    public abstract class RangeRestriction<TAddress> : IEquatable<RangeRestriction<TAddress>>, IStructuralEquatable
    {
        ...
        {
            return RangeRestriction.map<TAddress, a>((Func<TAddress, a>) new Address.Select<TAddress, a>(f), this);
        }
